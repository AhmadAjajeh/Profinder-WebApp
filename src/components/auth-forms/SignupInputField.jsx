  ...
  return (
    ...
    >
      ...
      <input
        ...
        name={name}
        type={inputType}
        class="px-5 py-3 w-full outline-none rounded-md font-light dark:bg-deepBlue dark:text-slate-200 focus:border-logoOrange  duration-100 focus:border-b-2 shadow-md placeholder:text-sm"
